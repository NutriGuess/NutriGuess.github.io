...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Create custom volume slider container
  const sliderContainer = document.createElement('div');
  sliderContainer.style.position = 'fixed';
  sliderContainer.style.top = '24px';    // aligned roughly under play button
  sliderContainer.style.left = '60px';   // 10 + 40 + 10 spacing
  ...
  // Create SVG for the slider track + thumb
  sliderContainer.innerHTML = `
    <svg width="100" height="24" xmlns="http://www.w3.org/2000/svg" style="overflow: visible;">
      ...
      <!-- Thumb group to hold your custom SVG -->
      <g id="thumb" cursor="pointer" transform="translate(12, 12)">
        <svg fill="#1c274c" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-volume-circle" width="20" height="20">
  ...
  function setThumbPosition(volume) {
    ...
    thumb.setAttribute('transform', `translate(${x}, 12)`);
  }

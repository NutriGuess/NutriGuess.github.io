...
window.addEventListener('DOMContentLoaded', () => {
  ...
  sliderContainer.style.top = '24px';
  ...
  sliderContainer.innerHTML = `
    <svg width="100" height="24" xmlns="http://www.w3.org/2000/svg" style="overflow: visible;">
      ...
      <g id="thumb" cursor="pointer" transform="translate(12, 12)">
        <svg fill="#425691" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-volume-circle" width="20" height="20">
  ...
  function setThumbPosition(volume) {
    ...
    thumb.setAttribute('transform', `translate(${x-5}, 2)`);
  }
